...
./scripts/update-dns-records-clouddns.sh $(yq r $PARAMS_YAML workload-cluster.ingress-fqdn)
./scripts/generate-and-apply-cluster-issuer-yaml-clouddns.sh $(yq r $PARAMS_YAML workload-cluster.name)
# Workload Step 5
