...
./scripts/update-dns-records-clouddns.sh $(yq r $PARAMS_YAML management-cluster.ingress-fqdn)
./scripts/generate-and-apply-cluster-issuer-yaml-clouddns.sh $(yq r $PARAMS_YAML management-cluster.name)
# Management Step 7
...
./scripts/update-dns-records-clouddns.sh $(yq r $PARAMS_YAML shared-services-cluster.ingress-fqdn)
./scripts/generate-and-apply-cluster-issuer-yaml-clouddns.sh $(yq r $PARAMS_YAML shared-services-cluster.name)
